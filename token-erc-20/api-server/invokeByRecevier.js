...
async function main() {
    try {
        ...
        const identity = await wallet.get('Dina');
        if (!identity) {
            console.log('An identity for the user "Dina" does not exist in the wallet');
        ...
        await gateway.connect(ccp, { wallet, identity: 'Dina', discovery: { enabled: true, asLocalhost: true } });
